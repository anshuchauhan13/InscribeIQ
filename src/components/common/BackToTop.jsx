    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-24 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-b from-[#6B52F9] to-[#8B79F2] text-white shadow-lg shadow-light-blue/40 ring-1 ring-white/25 md:bottom-28 md:right-9"
        >
